...
# Exercise 2 - Last Names vs Family size
...
st.write("Observation: Last name counts don’t perfectly match family sizes, since not all family members traveled together or shared the same ticket.")
